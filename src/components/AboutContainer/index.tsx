    ...
    <div className={styles.aboutContainer}>
      ...
      <div className={styles.contents}>
        <div className={styles.mainContents}>
          <Article title="Student Formula" imageUrl="/images/teamphoto.jpg">
          ...
          <Article title="KART" imageUrl="/images/teamphoto.jpg" right>
        ...
        <div className={styles.subContents}>
          <div>
            ...
            <Image src="/images/teamphoto.jpg" alt="" w={320} />
            <ul>
              <li>
